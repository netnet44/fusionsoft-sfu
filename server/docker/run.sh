...
export HTTPS_CERT_FULLCHAIN=${HTTPS_CERT_FULLCHAIN:="./certs/fullchain.pem"}
export HTTPS_CERT_PRIVKEY=${HTTPS_CERT_PRIVKEY:="./certs/privkey.pem"}
export MEDIASOUP_LISTEN_IP=${MEDIASOUP_LISTEN_IP:="0.0.0.0"}
export MEDIASOUP_MIN_PORT=${MEDIASOUP_MIN_PORT:="2000"}
export MEDIASOUP_MAX_PORT=${MEDIASOUP_MAX_PORT:="2100"}

export MEDIASOUP_SRC=/Users/iseungmin/Downloads/mediasoup-demo-3/server/node_modules/mediasoup
